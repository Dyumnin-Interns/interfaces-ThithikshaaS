...
class TestBench:     
    ...
    def constraint_setup(self):         
        ...
        #self.prob.addConstraint(lambda wr_addr,rd_en, wr_en, wr_dat: wr_addr == 0 and wr_dat == 0 if rd_en == 1 and wr_en == 0 else True, ['write_address', 'read_en', 'write_en', 'write_data'])         
        #self.prob.addConstraint(lambda rd_addr,rd_en, wr_en: rd_addr == 0 if rd_en == 0 and wr_en == 1 else True, ['read_address', 'read_en', 'write_en'])      
